...
import { FaBuilding, FaUserTie, FaUsers, FaHandshake, FaRegBuilding, FaChartLine, FaGlobe } from 'react-icons/fa';
        ...
        {categories.map((category, index) => (
          <div 
            ...
            onClick={() => navigate(category.path)}
             className="relative cursor-pointer rounded-xl p-8 transition-all duration-200 flex flex-col items-center text-center group bg-[#FAFBFF] shadow-sm hover:bg-[#01334C] hover:text-white"
          >
            <div className="w-14 h-14 rounded-full flex items-center justify-center mb-4 bg-[#01334C] group-hover:bg-white">
