...
import { FaRocket, FaFileAlt, FaCalculator, FaBalanceScale, FaFileInvoiceDollar, FaClipboardCheck } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="flex space-x-8">
              <button 
                ...
                className={`py-4 px-1 relative ${
                  activeTab === 'upcoming' 
                    ? 'text-[#01334C] font-medium' 
                    : 'text-gray-500 hover:text-gray-700'
                }`}
              >
                Upcoming
                {activeTab === 'upcoming' && (
                  <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#01334C]"></div>
                )}
              </button>
              <button 
        ...
        <div className="space-y-4">
          ...
          <div 
            key={index} 
            className="relative group bg-white rounded-lg p-5 hover:bg-[#01334C] hover:text-white transition-all duration-200 cursor-pointer flex items-center justify-between w-full"
            onClick={() => {
          ...
          >
            <div className="flex items-center space-x-4">
              <div className={`p-3 rounded-full bg-[#01334C] text-white`}>
            ...
            <div className="w-8 h-8 rounded-full bg-gray-50 group-hover:bg-white flex items-center justify-center">
              <MdKeyboardArrowRight className="h-5 w-5 text-[#01334C] group-hover:text-[#01334C]" />
            </div>
          </div>
          ))}
        </div>
